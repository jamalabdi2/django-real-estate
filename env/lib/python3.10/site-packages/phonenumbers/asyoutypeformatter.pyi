...
class AsYouTypeFormatter:
    ...
    def _get_formatting_template(
        self, number_pattern: str, number_format: str
    ) -> str: ...
    ...
    def _normalize_and_accrue_digits_and_plus_sign(
        self, next_char: str, remember_position: bool
    ) -> str: ...
