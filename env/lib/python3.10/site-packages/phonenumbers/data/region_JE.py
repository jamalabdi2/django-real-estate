...
PHONE_METADATA_JE = PhoneMetadata(
    id="JE",
    country_code=44,
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="7(?:(?:(?:50|82)9|937)\\d|7(?:00[378]|97[7-9]))\\d{5}",
    ...
    premium_rate=PhoneNumberDesc(
        national_number_pattern="(?:8(?:4(?:4(?:4(?:05|42|69)|703)|5(?:041|800))|7(?:0002|1206))|90(?:066[59]|1810|71(?:07|55)))\\d{4}",
    ...
    pager=PhoneNumberDesc(
        national_number_pattern="76(?:464|652)\\d{5}|76(?:0[0-28]|2[356]|34|4[01347]|5[49]|6[0-369]|77|8[14]|9[139])\\d{6}",
        example_number="7640123456",
        possible_length=(10,),
    ),
    uan=PhoneNumberDesc(
        national_number_pattern="(?:3(?:0(?:07(?:35|81)|8901)|3\\d{4}|4(?:4(?:4(?:05|42|69)|703)|5(?:041|800))|7(?:0002|1206))|55\\d{4})\\d{4}",
