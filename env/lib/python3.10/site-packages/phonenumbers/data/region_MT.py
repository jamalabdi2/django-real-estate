...
PHONE_METADATA_MT = PhoneMetadata(
    id="MT",
    country_code=356,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="20(?:3[1-4]|6[059])\\d{4}|2(?:0[19]|[1-357]\\d|60)\\d{5}",
        example_number="21001234",
        possible_length=(8,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:7(?:210|[79]\\d\\d)|9(?:[29]\\d\\d|69[67]|8(?:1[1-3]|89|97)))\\d{4}",
    ...
    premium_rate=PhoneNumberDesc(
        national_number_pattern="5(?:0(?:0(?:37|43)|(?:6\\d|70|9[0168])\\d)|[12]\\d0[1-5])\\d{3}",
