...
PHONE_METADATA_CH = PhoneMetadata(
    id="CH",
    country_code=41,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="8\\d{11}|[2-9]\\d{8}", possible_length=(9, 12)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:2[12467]|3[1-4]|4[134]|5[256]|6[12]|[7-9]1)\\d{7}",
