...
PHONE_METADATA_SK = PhoneMetadata(
    id="SK",
    country_code=421,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:2(?:16|[2-9]\\d{3})|(?:(?:[3-5][1-8]\\d|819)\\d|601[1-5])\\d)\\d{4}|(?:2|[3-5][1-8])1[67]\\d{3}|[3-5][1-8]16\\d\\d",
        example_number="221234567",
        possible_length=(6, 7, 9),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="909[1-9]\\d{5}|9(?:0[1-8]|1[0-24-9]|4[03-57-9]|5\\d)\\d{6}",
    ...
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="9090\\d{3}|(?:602|8(?:00|[5-9]\\d)|9(?:00|[78]\\d))\\d{6}",
        possible_length=(7, 9),
    ),
    national_prefix="0",
