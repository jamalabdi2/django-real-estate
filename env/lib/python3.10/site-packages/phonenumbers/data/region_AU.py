...
PHONE_METADATA_AU = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="1(?:[0-79]\\d{7}(?:\\d(?:\\d{2})?)?|8[0-24-9]\\d{7})|[2-478]\\d{8}|1\\d{4,7}",
    ...
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="1(?:3(?:00\\d{5}|45[0-4])|802)\\d{3}|1[38]00\\d{6}|13\\d{4}",
    ...
    number_format=[
        ...
        NumberFormat(
            pattern="(\\d{3})(\\d{3})", format="\\1 \\2", leading_digits_pattern=["19"]
        ),
        NumberFormat(
            pattern="(\\d{3})(\\d{4})",
            format="\\1 \\2",
