...
PHONE_METADATA_HU = PhoneMetadata(
    id="HU",
    country_code=36,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:1\\d|[27][2-9]|3[2-7]|4[24-9]|5[2-79]|6[23689]|8[2-57-9]|9[2-69])\\d{6}",
    ...
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="(?:[48]0\\d|680[29])\\d{5}", possible_length=(8, 9)
    ),
    national_prefix="06",
