...
PHONE_METADATA_ES = PhoneMetadata(
    id="ES",
    country_code=34,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="[5-9]\\d{8}", possible_length=(9,)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="96906(?:0[0-8]|1[1-9]|[2-9]\\d)\\d\\d|9(?:69(?:0[0-57-9]|[1-9]\\d)|73(?:[0-8]\\d|9[1-9]))\\d{4}|(?:8(?:[1356]\\d|[28][0-8]|[47][1-9])|9(?:[135]\\d|[268][0-8]|4[1-9]|7[124-9]))\\d{6}",
        example_number="810123456",
        possible_length=(9,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:590[16]00\\d|9(?:6906(?:09|10)|7390\\d\\d))\\d\\d|(?:6\\d|7[1-48])\\d{7}",
    ...
    number_format=[
        NumberFormat(pattern="(\\d{4})", format="\\1", leading_digits_pattern=["905"]),
        NumberFormat(
            pattern="(\\d{6})", format="\\1", leading_digits_pattern=["[79]9"]
        ),
        NumberFormat(
            pattern="(\\d{3})(\\d{3})(\\d{3})",
            format="\\1 \\2 \\3",
