...
PHONE_METADATA_IT = PhoneMetadata(
    id="IT",
    country_code=39,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="0\\d{5,10}|1\\d{8,10}|3(?:[0-8]\\d{7,10}|9\\d{7,8})|(?:55|70)\\d{8}|8\\d{5}(?:\\d{2,4})?",
    ...
    premium_rate=PhoneNumberDesc(
        national_number_pattern="(?:0878\\d{3}|89(?:2\\d|3[04]|4(?:[0-4]|[5-9]\\d\\d)|5[0-4]))\\d\\d|(?:1(?:44|6[346])|89(?:38|5[5-9]|9))\\d{6}",
    ...
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="848\\d{6}", possible_length=(9,)
    ),
    number_format=[
        NumberFormat(
            pattern="(\\d{4,5})",
            format="\\1",
            leading_digits_pattern=["1(?:0|9[246])", "1(?:0|9(?:2[2-9]|[46]))"],
        ),
        NumberFormat(
            pattern="(\\d{6})", format="\\1", leading_digits_pattern=["1(?:1|92)"]
        ),
        NumberFormat(
            pattern="(\\d{2})(\\d{4,6})",
            format="\\1 \\2",
        ...
        NumberFormat(
            pattern="(\\d{4})(\\d{4})", format="\\1 \\2", leading_digits_pattern=["894"]
        ),
        NumberFormat(
            pattern="(\\d{2})(\\d{3,4})(\\d{4})",
            format="\\1 \\2 \\3",
            leading_digits_pattern=["0[26]|5"],
        ),
        NumberFormat(
        ...
        NumberFormat(
            ...
            format="\\1 \\2 \\3",
            leading_digits_pattern=["0[13-57-9][0159]|14"],
        ),
        NumberFormat(
            pattern="(\\d{2})(\\d{4})(\\d{5})",
            format="\\1 \\2 \\3",
