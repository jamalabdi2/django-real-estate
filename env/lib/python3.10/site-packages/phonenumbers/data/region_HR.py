...
PHONE_METADATA_HR = PhoneMetadata(
    id="HR",
    country_code=385,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="1\\d{7}|(?:2[0-3]|3[1-5]|4[02-47-9]|5[1-3])\\d{6,7}",
        example_number="12345678",
        possible_length=(8, 9),
        possible_length_local_only=(6, 7),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="9(?:(?:0[1-9]|[12589]\\d)\\d\\d|7(?:[0679]\\d\\d|5(?:[01]\\d|44|77|9[67])))\\d{4}|98\\d{6}",
