...
PHONE_METADATA_BE = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="4\\d{8}|[1-9]\\d{7}", possible_length=(8, 9)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="80[2-8]\\d{5}|(?:1[0-69]|[23][2-8]|4[23]|5\\d|6[013-57-9]|71|8[1-79]|9[2-4])\\d{6}",
    ...
    premium_rate=PhoneNumberDesc(
        national_number_pattern="(?:70(?:2[0-57]|3[04-7]|44|6[4-69]|7[0579])|90\\d\\d)\\d{4}",
    ...
    uan=PhoneNumberDesc(
        national_number_pattern="78(?:0[57]|1[014-8]|2[25]|3[15-8]|48|[56]0|7[06-8]|9\\d)\\d{4}",
