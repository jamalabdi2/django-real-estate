...
PHONE_METADATA_UZ = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:33|[5-79]\\d|88)\\d{7}", possible_length=(9,)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:55\\d\\d|6(?:1(?:22|3[124]|4[1-4]|5[1-3578]|64)|2(?:22|3[0-57-9]|41)|5(?:22|3[3-7]|5[024-8])|6\\d\\d|7(?:[23]\\d|7[69])|9(?:22|4[1-8]|6[135]))|7(?:0(?:5[4-9]|6[0146]|7[124-6]|9[135-8])|(?:1[12]|8\\d)\\d|2(?:22|3[13-57-9]|4[1-3579]|5[14])|3(?:2\\d|3[1578]|4[1-35-7]|5[1-57]|61)|4(?:2\\d|3[1-579]|7[1-79])|5(?:22|5[1-9]|6[1457])|6(?:22|3[12457]|4[13-8])|9(?:22|5[1-9])))\\d{5}",
        example_number="669050123",
        possible_length=(9,),
    ),
