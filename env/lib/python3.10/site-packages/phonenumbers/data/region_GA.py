...
PHONE_METADATA_GA = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:[067]\\d|11)\\d{6}|[2-7]\\d{6}",
        possible_length=(7, 8),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="[01]1\\d{6}",
        example_number="01441234",
        possible_length=(8,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:(?:0[2-7]|7[467])\\d|6(?:0[0-4]|10|[256]\\d))\\d{5}|[2-7]\\d{6}",
