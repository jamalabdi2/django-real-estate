...
PHONE_METADATA_MU = PhoneMetadata(
    id="MU",
    country_code=230,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:2(?:[0346-8]\\d|1[0-7])|4(?:[013568]\\d|2[4-7])|54(?:[3-5]\\d|71)|6\\d\\d|8(?:14|3[129]))\\d{4}",
        example_number="54480123",
        possible_length=(7, 8),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="5(?:4(?:2[1-389]|7[1-9])|87[15-8])\\d{4}|(?:5(?:2[5-9]|4[3-689]|[57]\\d|8[0-689]|9[0-8])|7(?:0[0-2]|3[013]))\\d{5}",
    ...
    number_format=[
        ...
        NumberFormat(
            pattern="(\\d{5})(\\d{5})", format="\\1 \\2", leading_digits_pattern=["8"]
        ),
    ],
)
