...
PHONE_METADATA_CU = PhoneMetadata(
    id="CU",
    country_code=53,
    international_prefix="119",
    general_desc=PhoneNumberDesc(
        national_number_pattern="[27]\\d{6,7}|[34]\\d{5,7}|(?:5|8\\d\\d)\\d{7}",
        possible_length=(6, 7, 8, 10),
        possible_length_local_only=(4, 5),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:3[23]|48)\\d{4,6}|(?:31|4[36]|8(?:0[25]|78)\\d)\\d{6}|(?:2[1-4]|4[1257]|7\\d)\\d{5,6}",
