...
PHONE_METADATA_EE = PhoneMetadata(
    id="EE",
    country_code=372,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="8\\d{9}|[4578]\\d{7}|(?:[3-8]\\d|90)\\d{5}",
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:5\\d{5}|8(?:1(?:0(?:000|[3-9]\\d\\d)|(?:1(?:0[236]|1\\d)|(?:2[0-59]|[3-79]\\d)\\d)\\d)|2(?:0(?:000|(?:19|[2-7]\\d)\\d)|(?:(?:[124-6]\\d|3[5-9])\\d|7(?:[0-3679]\\d|8[13-9])|8(?:[2-6]\\d|7[01]))\\d)|[349]\\d{4}))\\d\\d|5(?:(?:[02]\\d|5[0-478])\\d|1(?:[0-8]\\d|95)|6(?:4[0-4]|5[1-589]))\\d{3}",
    ...
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="800[2-9]\\d{3}", possible_length=(7,)
    ),
    number_format=[
        NumberFormat(
            pattern="(\\d{3})(\\d{4})",
        ...
        NumberFormat(
            pattern="(\\d{4})(\\d{3,4})",
            format="\\1 \\2",
            leading_digits_pattern=["[45]|8(?:00|[1-49])", "[45]|8(?:00[1-9]|[1-49])"],
        ),
        NumberFormat(
            pattern="(\\d{2})(\\d{2})(\\d{4})",
            format="\\1 \\2 \\3",
