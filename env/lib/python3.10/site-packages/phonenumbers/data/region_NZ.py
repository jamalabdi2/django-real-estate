...
PHONE_METADATA_NZ = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="[29]\\d{7,9}|50\\d{5}(?:\\d{2,3})?|6[0-35-9]\\d{6}|7\\d{7,8}|8\\d{4,9}|(?:11\\d|[34])\\d{7}",
        possible_length=(5, 6, 7, 8, 9, 10),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="24099\\d{3}|(?:3[2-79]|[49][2-9]|6[235-9]|7[2-57-9])\\d{6}",
        example_number="32345678",
        possible_length=(8,),
        possible_length_local_only=(7,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="2[0-27-9]\\d{7,8}|2(?:1\\d|75)\\d{5}",
    ...
    premium_rate=PhoneNumberDesc(
        national_number_pattern="(?:11\\d{5}|50(?:0[08]|30|66|77|88))\\d{3}|90\\d{6,8}",
    ...
    pager=PhoneNumberDesc(
        national_number_pattern="[28]6\\d{6,7}",
        example_number="26123456",
        possible_length=(8, 9),
    ),
    uan=PhoneNumberDesc(
        national_number_pattern="8(?:1[6-9]|22|3\\d|4[045]|5[459]|7[0-3579]|90)\\d{2,7}",
    ...
    number_format=[
        NumberFormat(
            pattern="(\\d{2})(\\d{3,8})",
            format="\\1 \\2",
            leading_digits_pattern=["8[1-579]"],
            national_prefix_formatting_rule="0\\1",
        ),
        NumberFormat(
            pattern="(\\d{3})(\\d{2})(\\d{2,3})",
            format="\\1 \\2 \\3",
            leading_digits_pattern=["50[036-8]|[89]0", "50(?:[0367]|88)|[89]0"],
            national_prefix_formatting_rule="0\\1",
        ),
        NumberFormat(
            pattern="(\\d)(\\d{3})(\\d{4})",
        ...
        NumberFormat(
            ...
            format="\\1 \\2 \\3",
            leading_digits_pattern=["2(?:10|74)|[59]|80"],
            national_prefix_formatting_rule="0\\1",
        ),
        NumberFormat(
        ...
        NumberFormat(
            ...
            format="\\1 \\2 \\3",
            leading_digits_pattern=["2(?:[169]|7[0-35-9])|7|86"],
            national_prefix_formatting_rule="0\\1",
        ),
    ],
