...
PHONE_METADATA_870 = PhoneMetadata(
    id="001",
    country_code=870,
    international_prefix=None,
    general_desc=PhoneNumberDesc(
        national_number_pattern="7\\d{11}|[35-7]\\d{8}", possible_length=(9, 12)
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:[356]|774[45])\\d{8}|7[6-8]\\d{7}",
