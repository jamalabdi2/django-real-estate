...
PHONE_METADATA_AZ = PhoneMetadata(
    id="AZ",
    country_code=994,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:2[12]428|3655[02])\\d{4}|(?:2(?:22[0-79]|63[0-28])|3654)\\d{5}|(?:(?:1[28]|46)\\d|2(?:[014-6]2|[23]3))\\d{6}",
        example_number="123123456",
        possible_length=(9,),
        possible_length_local_only=(7,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="36554\\d{4}|(?:[16]0|4[04]|5[015]|7[07]|99)\\d{7}",
