...
PHONE_METADATA_GP = PhoneMetadata(
    id="GP",
    country_code=590,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="590\\d{6}|(?:69|80|9\\d)\\d{7}", possible_length=(9,)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="590(?:0[1-68]|[14][0-24-9]|2[0-68]|3[1289]|5[3-579]|[68][0-689]|7[08]|9\\d)\\d{4}",
    ...
    voip=PhoneNumberDesc(
        national_number_pattern="9(?:(?:395|76[018])\\d|475[0-2])\\d{4}",
