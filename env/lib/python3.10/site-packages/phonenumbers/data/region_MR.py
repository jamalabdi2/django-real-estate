...
PHONE_METADATA_MR = PhoneMetadata(
    id="MR",
    country_code=222,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:[2-4]\\d\\d|800)\\d{5}", possible_length=(8,)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:25[08]|35\\d|45[1-7])\\d{5}",
        example_number="35123456",
        possible_length=(8,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="[2-4][0-46-9]\\d{6}",
