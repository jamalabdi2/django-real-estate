...
PHONE_METADATA_GY = PhoneMetadata(
    id="GY",
    country_code=592,
    international_prefix="001",
    general_desc=PhoneNumberDesc(
        national_number_pattern="9008\\d{3}|(?:[2-467]\\d\\d|862)\\d{4}",
        possible_length=(7,),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:2(?:1[6-9]|2[0-35-9]|3[1-4]|5[3-9]|6\\d|7[0-24-79])|3(?:2[25-9]|3\\d)|4(?:4[0-24]|5[56])|77[1-57])\\d{4}",
        example_number="2201234",
        possible_length=(7,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:6\\d\\d|70[0-35-7])\\d{4}",
