...
PHONE_METADATA_RE = PhoneMetadata(
    id="RE",
    country_code=262,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:26|[689]\\d)\\d{7}", possible_length=(9,)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="26(?:2\\d\\d|3(?:0\\d|1[0-3]))\\d{4}",
        example_number="262161234",
        possible_length=(9,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:69(?:2\\d\\d|3(?:0[0-46]|1[013]|2[0-2]|3[0-39]|4\\d|5[0-5]|6[0-6]|7[0-27]|8[0-8]|9[0-479]))|9(?:399[0-3]|479[0-2]|76(?:2[27]|3[0-37]|9\\d)))\\d{4}",
