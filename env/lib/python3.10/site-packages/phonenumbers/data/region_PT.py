...
PHONE_METADATA_PT = PhoneMetadata(
    id="PT",
    country_code=351,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="2(?:[12]\\d|3[1-689]|4[1-59]|[57][1-9]|6[1-35689]|8[1-69]|9[1256])\\d{6}",
        example_number="212345678",
        possible_length=(9,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="6(?:[06]92(?:30|9\\d)|[35]92(?:3[03]|9\\d))\\d{3}|(?:(?:16|6[0356])93|9(?:[1-36]\\d\\d|480))\\d{5}",
    ...
    premium_rate=PhoneNumberDesc(
        national_number_pattern="(?:6(?:0[178]|4[68])\\d|76(?:0[1-57]|1[2-47]|2[237]))\\d{5}",
