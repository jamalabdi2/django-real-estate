...
PHONE_METADATA_GE = PhoneMetadata(
    id="GE",
    country_code=995,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:3(?:[256]\\d|4[124-9]|7[0-4])|4(?:1\\d|2[2-7]|3[1-79]|4[2-8]|7[239]|9[1-7]))\\d{6}",
    ...
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="70[67]\\d{6}", possible_length=(9,)
    ),
    national_prefix="0",
