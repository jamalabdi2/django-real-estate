...
PHONE_METADATA_TR = PhoneMetadata(
    id="TR",
    country_code=90,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="4\\d{6}|8\\d{11,12}|(?:[2-58]\\d\\d|900)\\d{7}",
        possible_length=(7, 10, 12, 13),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:2(?:[13][26]|[28][2468]|[45][268]|[67][246])|3(?:[13][28]|[24-6][2468]|[78][02468]|92)|4(?:[16][246]|[23578][2468]|4[26]))\\d{7}",
        example_number="2123456789",
        possible_length=(10,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="56161\\d{5}|5(?:0[15-7]|1[06]|24|[34]\\d|5[1-59]|9[46])\\d{7}",
    ...
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="(?:444|811\\d{3})\\d{4}", possible_length=(7, 10)
    ),
    national_prefix="0",
