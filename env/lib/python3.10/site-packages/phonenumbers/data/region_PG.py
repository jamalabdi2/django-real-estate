...
PHONE_METADATA_PG = PhoneMetadata(
    id="PG",
    country_code=675,
    international_prefix="00|140[1-3]",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:180|[78]\\d{3})\\d{4}|(?:[2-589]\\d|64)\\d{5}",
        possible_length=(7, 8),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:(?:3[0-2]|4[257]|5[34]|9[78])\\d|64[1-9]|85[02-46-9])\\d{4}",
