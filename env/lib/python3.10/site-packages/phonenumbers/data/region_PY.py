...
PHONE_METADATA_PY = PhoneMetadata(
    id="PY",
    country_code=595,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="59\\d{4,6}|9\\d{5,10}|(?:[2-46-8]\\d|5[0-8])\\d{4,7}",
        possible_length=(6, 7, 8, 9, 10, 11),
        possible_length_local_only=(5,),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:[26]1|3[289]|4[1246-8]|7[1-3]|8[1-36])\\d{5,7}|(?:2(?:2[4-68]|[4-68]\\d|7[15]|9[1-5])|3(?:18|3[167]|4[2357]|51|[67]\\d)|4(?:3[12]|5[13]|9[1-47])|5(?:[1-4]\\d|5[02-4])|6(?:3[1-3]|44|7[1-8])|7(?:4[0-4]|5\\d|6[1-578]|75|8[0-8])|858)\\d{5,6}",
