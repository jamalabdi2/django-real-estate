...
PHONE_METADATA_AS = PhoneMetadata(
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="6846(?:22|33|44|55|77|88|9[19])\\d{4}",
        example_number="6846221234",
        possible_length=(10,),
        possible_length_local_only=(7,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="684(?:2(?:48|5[2468]|7[26])|7(?:3[13]|70|82))\\d{4}",
        example_number="6847331234",
        possible_length=(10,),
        possible_length_local_only=(7,),
    ),
