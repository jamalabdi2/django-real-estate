...
PHONE_METADATA_PS = PhoneMetadata(
    id="PS",
    country_code=970,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="[2489]2\\d{6}|(?:1\\d|5)\\d{8}",
        possible_length=(8, 9, 10),
        possible_length_local_only=(7,),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:22[2-47-9]|42[45]|82[014-68]|92[3569])\\d{5}",
        example_number="22234567",
        possible_length=(8,),
        possible_length_local_only=(7,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="5[69]\\d{7}",
        example_number="599123456",
        possible_length=(9,),
    ),
