...
PHONE_METADATA_TZ = PhoneMetadata(
    id="TZ",
    country_code=255,
    international_prefix="00[056]",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:[25-8]\\d|41|90)\\d{7}", possible_length=(9,)
    ),
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="77[2-9]\\d{6}|(?:6[125-9]|7[13-689])\\d{7}",
    ...
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="(?:8(?:[04]0|6[01])|90\\d)\\d{6}", possible_length=(9,)
    ),
    national_prefix="0",
    ...
    number_format=[
        ...
        NumberFormat(
            pattern="(\\d{2})(\\d{7})", format="\\1 \\2", leading_digits_pattern=["5"]
        ),
        NumberFormat(
            pattern="(\\d{3})(\\d{3})(\\d{3})",
            format="\\1 \\2 \\3",
