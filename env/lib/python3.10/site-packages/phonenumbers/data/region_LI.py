...
PHONE_METADATA_LI = PhoneMetadata(
    id="LI",
    country_code=423,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:2(?:01|1[27]|2[02]|3\\d|6[02-578]|96)|3(?:[24]0|33|7[0135-7]|8[048]|9[0269]))\\d{4}",
        example_number="2345678",
        possible_length=(7,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:6(?:(?:4[5-9]|5[0-4])\\d|6(?:[0245]\\d|[17]0|3[7-9]))\\d|7(?:[37-9]\\d|42|56))\\d{4}",
    ...
    premium_rate=PhoneNumberDesc(
        national_number_pattern="90(?:02[258]|1(?:23|3[14])|66[136])\\d\\d",
    ...
    number_format=[
        NumberFormat(
            pattern="(\\d{3})(\\d{2})(\\d{2})",
            format="\\1 \\2 \\3",
            leading_digits_pattern=["[2379]|8(?:0[09]|7)", "[2379]|8(?:0(?:02|9)|7)"],
