...
PHONE_METADATA_IE = PhoneMetadata(
    id="IE",
    country_code=353,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:1\\d|[2569])\\d{6,8}|4\\d{6,9}|7\\d{8}|8\\d{8,9}",
        possible_length=(7, 8, 9, 10),
        possible_length_local_only=(5, 6),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:1\\d|21)\\d{6,7}|(?:2[24-9]|4(?:0[24]|5\\d|7)|5(?:0[45]|1\\d|8)|6(?:1\\d|[237-9])|9(?:1\\d|[35-9]))\\d{5}|(?:23|4(?:[1-469]|8\\d)|5[23679]|6[4-6]|7[14]|9[04])\\d{7}",
    ...
    voicemail=PhoneNumberDesc(
        national_number_pattern="88210[1-9]\\d{4}|8(?:[35-79]5\\d\\d|8(?:[013-9]\\d\\d|2(?:[01][1-9]|[2-9]\\d)))\\d{5}",
        example_number="8551234567",
        possible_length=(10,),
    ),
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="18[59]0\\d{6}", possible_length=(10,)
    ),
    national_prefix="0",
