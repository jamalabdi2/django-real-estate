...
PHONE_METADATA_FR = PhoneMetadata(
    id="FR",
    country_code=33,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="[1-9]\\d{8}", possible_length=(9,)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:[1-35]\\d|4[1-9])\\d{7}",
        example_number="123456789",
        possible_length=(9,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:6(?:[0-24-8]\\d|3[0-8]|9[589])|7[3-9]\\d)\\d{6}",
    ...
    premium_rate=PhoneNumberDesc(
        national_number_pattern="836(?:0[0-36-9]|[1-9]\\d)\\d{4}|8(?:1[2-9]|2[2-47-9]|3[0-57-9]|[569]\\d|8[0-35-9])\\d{6}",
    ...
    number_format=[
        NumberFormat(pattern="(\\d{4})", format="\\1", leading_digits_pattern=["10"]),
        NumberFormat(
            pattern="(\\d{3})(\\d{3})", format="\\1 \\2", leading_digits_pattern=["1"]
        ),
        NumberFormat(
