...
PHONE_METADATA_YT = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:(?:(?:26|63)9|80\\d)\\d|9398)\\d{5}",
        possible_length=(9,),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="269(?:0[0-467]|5[0-3]|6\\d|[78]0)\\d{4}",
        example_number="269601234",
        possible_length=(9,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:639(?:0[0-79]|1[019]|[267]\\d|3[09]|40|5[05-9]|9[04-79])|9398[01])\\d{4}",
        example_number="639012345",
        possible_length=(9,),
    ),
