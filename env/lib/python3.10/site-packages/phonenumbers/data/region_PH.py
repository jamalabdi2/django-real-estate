...
PHONE_METADATA_PH = PhoneMetadata(
    id="PH",
    country_code=63,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:[2-7]|9\\d)\\d{8}|2\\d{5}|(?:1800|8)\\d{7,9}",
        possible_length=(6, 8, 9, 10, 11, 12, 13),
        possible_length_local_only=(4, 5, 7),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:(?:2[3-8]|3[2-68]|4[2-9]|5[2-6]|6[2-58]|7[24578])\\d{3}|88(?:22\\d\\d|42))\\d{4}|(?:2|8[2-8]\\d\\d)\\d{5}",
        example_number="232345678",
        possible_length=(6, 8, 9, 10),
        possible_length_local_only=(4, 5, 7),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:8(?:1[37]|9[5-8])|9(?:0[5-9]|1[0-24-9]|[235-7]\\d|4[2-9]|8[135-9]|9[1-9]))\\d{7}",
