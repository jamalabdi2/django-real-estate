...
PHONE_METADATA_SY = PhoneMetadata(
    id="SY",
    country_code=963,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="21\\d{6,7}|(?:1(?:[14]\\d|[2356])|2[235]|3(?:[13]\\d|4)|4[134]|5[1-3])\\d{6}",
        example_number="112345678",
        possible_length=(8, 9),
        possible_length_local_only=(6, 7),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="9[1-689]\\d{7}",
        example_number="944567890",
        possible_length=(9,),
    ),
    national_prefix="0",
