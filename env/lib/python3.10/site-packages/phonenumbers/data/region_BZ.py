...
PHONE_METADATA_BZ = PhoneMetadata(
    id="BZ",
    country_code=501,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:0800\\d|[2-8])\\d{6}", possible_length=(7, 11)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:2(?:[02]\\d|36|[68]0)|[3-58](?:[02]\\d|[68]0)|7(?:[02]\\d|32|[68]0))\\d{4}",
