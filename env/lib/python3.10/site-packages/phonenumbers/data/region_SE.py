...
PHONE_METADATA_SE = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:[26]\\d\\d|9)\\d{9}|[1-9]\\d{8}|[1-689]\\d{7}|[1-4689]\\d{6}|2\\d{5}",
    ...
    premium_rate=PhoneNumberDesc(
        national_number_pattern="649\\d{6}|99[1-59]\\d{4}(?:\\d{3})?|9(?:00|39|44)[1-8]\\d{3,6}",
    ...
    number_format=[
        ...
        NumberFormat(
            pattern="(\\d{2})(\\d{3})(\\d{2})",
            format="\\1-\\2 \\3",
            leading_digits_pattern=["[12][136]|3[356]|4[0246]|6[03]|90[1-9]"],
            national_prefix_formatting_rule="0\\1",
        ),
        NumberFormat(
