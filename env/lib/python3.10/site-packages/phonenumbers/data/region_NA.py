...
PHONE_METADATA_NA = PhoneMetadata(
    ...
    premium_rate=PhoneNumberDesc(
        national_number_pattern="8701\\d{5}",
        example_number="870123456",
        possible_length=(9,),
    ),
    voip=PhoneNumberDesc(
        national_number_pattern="8(?:3\\d\\d|86)\\d{5}",
        example_number="88612345",
        possible_length=(8, 9),
    ),
    national_prefix="0",
