...
PHONE_METADATA_CN = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="1[127]\\d{8,9}|2\\d{9}(?:\\d{2})?|[12]\\d{6,7}|86\\d{6}|(?:1[03-689]\\d|6)\\d{7,9}|(?:[3-579]\\d|8[0-57-9])\\d{6,9}",
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="1740[0-5]\\d{6}|1(?:[38]\\d|4[57]|[59][0-35-9]|6[25-7]|7[0-35-8])\\d{8}",
    ...
    number_format=[
        NumberFormat(
            pattern="(\\d{5,6})", format="\\1", leading_digits_pattern=["10|96"]
        ),
        NumberFormat(
            pattern="(\\d{2})(\\d{5,6})",
            format="\\1 \\2",
        ...
        NumberFormat(
            pattern="(\\d{3})(\\d{7,8})", format="\\1 \\2", leading_digits_pattern=["9"]
        ),
        NumberFormat(
            pattern="(\\d{4})(\\d{3})(\\d{4})",
            format="\\1 \\2 \\3",
