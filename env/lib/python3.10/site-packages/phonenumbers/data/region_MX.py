...
PHONE_METADATA_MX = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="1(?:(?:[27]2|44|99)[1-9]|65[0-689])\\d{7}|(?:1(?:[01]\\d|2[13-9]|[35][1-9]|4[0-35-9]|6[0-46-9]|7[013-9]|8[1-79]|9[1-8])|[2-9]\\d)\\d{8}",
    ...
    shared_cost=PhoneNumberDesc(
        national_number_pattern="300\\d{7}",
        example_number="3001234567",
        possible_length=(10,),
    ),
    personal_number=PhoneNumberDesc(
        national_number_pattern="500\\d{7}",
        example_number="5001234567",
        possible_length=(10,),
    ),
    ...
    number_format=[
        NumberFormat(pattern="(\\d{5})", format="\\1", leading_digits_pattern=["53"]),
        NumberFormat(
            pattern="(\\d{2})(\\d{4})(\\d{4})",
            format="\\1 \\2 \\3",
