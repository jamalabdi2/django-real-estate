...
PHONE_METADATA_IM = PhoneMetadata(
    id="IM",
    country_code=44,
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="76245[06]\\d{4}|7(?:4576|[59]24\\d|624[0-4689])\\d{5}",
    ...
    premium_rate=PhoneNumberDesc(
        national_number_pattern="8(?:440[49]06|72299\\d)\\d{3}|(?:8(?:45|70)|90[0167])624\\d{4}",
    ...
    uan=PhoneNumberDesc(
        national_number_pattern="3440[49]06\\d{3}|(?:3(?:08162|3\\d{4}|45624|7(?:0624|2299))|55\\d{4})\\d{4}",
