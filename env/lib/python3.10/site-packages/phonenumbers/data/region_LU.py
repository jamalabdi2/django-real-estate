...
PHONE_METADATA_LU = PhoneMetadata(
    id="LU",
    country_code=352,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="35[013-9]\\d{4,8}|6\\d{8}|35\\d{2,4}|(?:[2457-9]\\d|3[0-46-9])\\d{2,9}",
        possible_length=(4, 5, 6, 7, 8, 9, 10, 11),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:35[013-9]|80[2-9]|90[89])\\d{1,8}|(?:2[2-9]|3[0-46-9]|[457]\\d|8[13-9]|9[2-579])\\d{2,9}",
