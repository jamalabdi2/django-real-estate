...
PHONE_METADATA_TN = PhoneMetadata(
    id="TN",
    country_code=216,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="[2-57-9]\\d{7}", possible_length=(8,)
    ),
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="3(?:001|[12]40)\\d{4}|(?:(?:[259]\\d|4[0-7])\\d|3(?:1[1-35]|6[0-4]|91))\\d{5}",
