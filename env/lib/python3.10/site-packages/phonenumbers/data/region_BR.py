...
PHONE_METADATA_BR = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:[1-46-9]\\d\\d|5(?:[0-46-9]\\d|5[0-46-9]))\\d{8}|[1-9]\\d{9}|[3589]\\d{8}|[34]\\d{7}",
        possible_length=(8, 9, 10, 11),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:[14689][1-9]|2[12478]|3[1-578]|5[13-5]|7[13-579])[2-5]\\d{7}",
        example_number="1123456789",
        possible_length=(10,),
        possible_length_local_only=(8,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:[14689][1-9]|2[12478]|3[1-578]|5[13-5]|7[13-579])(?:7|9\\d)\\d{7}",
    ...
    shared_cost=PhoneNumberDesc(
        national_number_pattern="(?:30[03]\\d{3}|4(?:0(?:0\\d|20)|370))\\d{4}|300\\d{5}",
        example_number="40041234",
        possible_length=(8, 10),
    ),
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="30(?:0\\d{5,7}|3\\d{7})|40(?:0\\d|20)\\d{4}|800\\d{6,7}",
