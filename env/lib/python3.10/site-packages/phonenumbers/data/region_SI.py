...
PHONE_METADATA_SI = PhoneMetadata(
    id="SI",
    country_code=386,
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="65(?:[178]\\d|5[56]|6[01])\\d{4}|(?:[37][01]|4[0139]|51|6[489])\\d{6}",
    ...
    voip=PhoneNumberDesc(
        national_number_pattern="(?:59\\d\\d|8(?:1(?:[67]\\d|8[0-589])|2(?:0\\d|2[0-37-9]|8[0-2489])|3[389]\\d))\\d{4}",
