...
PHONE_METADATA_RO = PhoneMetadata(
    id="RO",
    country_code=40,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="[23][13-6]\\d{7}|(?:2(?:19\\d|[3-6]\\d9)|31\\d\\d)\\d\\d",
        example_number="211234567",
        possible_length=(6, 9),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="7020\\d{5}|7(?:0[013-9]|1[0-3]|[2-7]\\d|8[03-8]|9[0-29])\\d{6}",
