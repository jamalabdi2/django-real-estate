...
PHONE_METADATA_UY = PhoneMetadata(
    id="UY",
    country_code=598,
    international_prefix="0(?:0|1[3-9]\\d)",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:0004|4)\\d{9}|[1249]\\d{7}|(?:[49]\\d|80)\\d{5}",
        possible_length=(7, 8, 10, 13),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:1(?:770|987)|(?:2\\d|4[2-7])\\d\\d)\\d{4}",
    ...
    toll_free=PhoneNumberDesc(
        national_number_pattern="(?:(?:0004|4)\\d{5}|80[05])\\d{4}|405\\d{4}",
