...
PHONE_METADATA_LV = PhoneMetadata(
    id="LV",
    country_code=371,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:[268]\\d|90)\\d{6}", possible_length=(8,)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="6\\d{7}",
        example_number="63123456",
        possible_length=(8,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="23(?:23[0-57-9]|33[0238])\\d{3}|2(?:[0-24-9]\\d\\d|3(?:0[07]|[14-9]\\d|2[024-9]|3[0-24-9]))\\d{4}",
    ...
    number_format=[
        NumberFormat(
            pattern="(\\d{2})(\\d{3})(\\d{3})",
            format="\\1 \\2 \\3",
            leading_digits_pattern=["[269]|8[01]"],
        )
    ],
