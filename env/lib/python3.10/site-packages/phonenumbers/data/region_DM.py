...
PHONE_METADATA_DM = PhoneMetadata(
    id="DM",
    country_code=1,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="767(?:2(?:55|66)|4(?:2[01]|4[0-25-9])|50[0-4])\\d{4}",
        example_number="7674201234",
        possible_length=(10,),
        possible_length_local_only=(7,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="767(?:2(?:[2-4689]5|7[5-7])|31[5-7]|61[1-8]|70[1-6])\\d{4}",
        example_number="7672251234",
        possible_length=(10,),
        possible_length_local_only=(7,),
    ),
