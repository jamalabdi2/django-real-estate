...
PHONE_METADATA_PL = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:6|8\\d\\d)\\d{7}|[1-9]\\d{6}(?:\\d{2})?|[26]\\d{5}",
        possible_length=(6, 7, 8, 9, 10),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="47\\d{7}|(?:1[2-8]|2[2-69]|3[2-4]|4[1-468]|5[24-689]|6[1-3578]|7[14-7]|8[1-79]|9[145])(?:[02-9]\\d{6}|1(?:[0-8]\\d{5}|9\\d{3}(?:\\d{2})?))",
        example_number="123456789",
        possible_length=(7, 9),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="21(?:1(?:[145]\\d|3[1-5])|2[0-4]\\d)\\d{4}|(?:45|5[0137]|6[069]|7[2389]|88)\\d{7}",
    ...
    number_format=[
        NumberFormat(pattern="(\\d{5})", format="\\1", leading_digits_pattern=["19"]),
        NumberFormat(
            pattern="(\\d{3})(\\d{3})",
            format="\\1 \\2",
