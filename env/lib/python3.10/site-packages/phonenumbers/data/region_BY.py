...
PHONE_METADATA_BY = PhoneMetadata(
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:1(?:5(?:1[1-5]|[24]\\d|6[2-4]|9[1-7])|6(?:[235]\\d|4[1-7])|7\\d\\d)|2(?:1(?:[246]\\d|3[0-35-9]|5[1-9])|2(?:[235]\\d|4[0-8])|3(?:[26]\\d|3[02-79]|4[024-7]|5[03-7])))\\d{5}",
        example_number="152450911",
        possible_length=(9,),
        possible_length_local_only=(5, 6, 7),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:2(?:5[5-79]|9[1-9])|(?:33|44)\\d)\\d{6}",
    ...
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="800\\d{3,7}|(?:8(?:0[13]|10|20\\d)|902)\\d{7}",
        possible_length=(6, 7, 8, 9, 10, 11),
    ),
