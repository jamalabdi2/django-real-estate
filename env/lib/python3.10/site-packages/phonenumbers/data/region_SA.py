...
PHONE_METADATA_SA = PhoneMetadata(
    id="SA",
    country_code=966,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="1(?:1\\d|2[24-8]|3[35-8]|4[3-68]|6[2-5]|7[235-7])\\d{6}",
        example_number="112345678",
        possible_length=(9,),
        possible_length_local_only=(7,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="579[01]\\d{5}|5(?:[013-689]\\d|7[0-35-8])\\d{6}",
    ...
    number_format=[
        NumberFormat(
            pattern="(\\d{4})(\\d{5})", format="\\1 \\2", leading_digits_pattern=["9"]
        ),
        NumberFormat(
            pattern="(\\d{2})(\\d{3})(\\d{4})",
            format="\\1 \\2 \\3",
