...
PHONE_METADATA_NO = PhoneMetadata(
    id="NO",
    country_code=47,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:0|[2-9]\\d{3})\\d{4}", possible_length=(5, 8)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:2[1-4]|3[1-3578]|5[1-35-7]|6[1-4679]|7[0-8])\\d{6}",
        example_number="21234567",
        possible_length=(8,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:4[015-8]|59|9\\d)\\d{6}",
    ...
    uan=PhoneNumberDesc(
        national_number_pattern="(?:0[2-9]|81(?:0(?:0[7-9]|1\\d)|5\\d\\d))\\d{3}",
