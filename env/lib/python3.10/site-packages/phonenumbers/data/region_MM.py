...
PHONE_METADATA_MM = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="1\\d{5,7}|95\\d{6}|(?:[4-7]|9[0-46-9])\\d{6,8}|(?:2|8\\d)\\d{5,8}",
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:17[01]|9(?:2(?:[0-4]|[56]\\d\\d)|(?:3(?:[0-36]|4\\d)|(?:6\\d|8[89]|9[4-8])\\d|7(?:3|40|[5-9]\\d))\\d|4(?:(?:[0245]\\d|[1379])\\d|88)|5[0-6])\\d)\\d{4}|9[69]1\\d{6}|9(?:[68]\\d|9[089])\\d{5}",
        example_number="92123456",
        possible_length=(7, 8, 9, 10),
    ),
    toll_free=PhoneNumberDesc(
        national_number_pattern="80080(?:0[1-9]|2\\d)\\d{3}",
        example_number="8008001234",
        possible_length=(10,),
    ),
    voip=PhoneNumberDesc(
        national_number_pattern="1333\\d{4}|[12]468\\d{4}",
        example_number="13331234",
        possible_length=(8,),
    ),
    national_prefix="0",
    ...
    number_format=[
        ...
        NumberFormat(
            ...
            format="\\1 \\2 \\3",
            leading_digits_pattern=["[4-7]|8[1-35]"],
            national_prefix_formatting_rule="0\\1",
        ),
        NumberFormat(
            pattern="(\\d)(\\d{3})(\\d{4,6})",
