...
PHONE_METADATA_NG = PhoneMetadata(
    id="NG",
    country_code=234,
    international_prefix="009",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:[124-7]|9\\d{3})\\d{6}|[1-9]\\d{7}|[78]\\d{9,13}",
        possible_length=(7, 8, 10, 11, 12, 13, 14),
        possible_length_local_only=(5, 6),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:(?:[1-356]\\d|4[02-8]|8[2-9])\\d|9(?:0[3-9]|[1-9]\\d))\\d{5}|7(?:0(?:[013-689]\\d|2[0-24-9])\\d{3,4}|[1-79]\\d{6})|(?:[12]\\d|4[147]|5[14579]|6[1578]|7[1-3578])\\d{5}",
        example_number="18040123",
        possible_length=(7, 8),
        possible_length_local_only=(5, 6),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:702[0-24-9]|819[01])\\d{6}|(?:70[13-689]|8(?:0[1-9]|1[0-8])|9(?:0[1-9]|1[1-356]))\\d{7}",
    ...
    number_format=[
        ...
        NumberFormat(
            ...
            format="\\1 \\2 \\3",
            leading_digits_pattern=["[3-7]|8[2-9]"],
            national_prefix_formatting_rule="0\\1",
        ),
        NumberFormat(
