...
PHONE_METADATA_YE = PhoneMetadata(
    id="YE",
    country_code=967,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="78[0-7]\\d{4}|17\\d{6}|(?:[12][2-68]|3[2358]|4[2-58]|5[2-6]|6[3-58]|7[24-6])\\d{5}",
        example_number="1234567",
        possible_length=(7, 8),
        possible_length_local_only=(6,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="7[01378]\\d{7}",
    ...
    number_format=[
        NumberFormat(
            pattern="(\\d)(\\d{3})(\\d{3,4})",
            format="\\1 \\2 \\3",
            leading_digits_pattern=["[1-6]|7(?:[24-6]|8[0-7])"],
