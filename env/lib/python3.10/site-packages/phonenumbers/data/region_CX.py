...
PHONE_METADATA_CX = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="1(?:[0-79]\\d{8}(?:\\d{2})?|8[0-24-9]\\d{7})|[148]\\d{8}|1\\d{5,7}",
        possible_length=(6, 7, 8, 9, 10, 12),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="8(?:51(?:0(?:01|30|59|88)|1(?:17|46|75)|2(?:22|35))|91(?:00[6-9]|1(?:[28]1|49|78)|2(?:09|63)|3(?:12|26|75)|4(?:56|97)|64\\d|7(?:0[01]|1[0-2])|958))\\d{3}",
        example_number="891641234",
        possible_length=(9,),
        possible_length_local_only=(8,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="4(?:(?:79|94)[01]|83[0-389])\\d{5}|4(?:[0-3]\\d|4[047-9]|5[0-25-9]|6[016-9]|7[02-8]|8[0-24-9]|9[0-37-9])\\d{6}",
    ...
    shared_cost=PhoneNumberDesc(
        national_number_pattern="13(?:00\\d{6}(?:\\d{2})?|45[0-4]\\d{3})|13\\d{4}",
