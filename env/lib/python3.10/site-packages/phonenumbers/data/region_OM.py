...
PHONE_METADATA_OM = PhoneMetadata(
    id="OM",
    country_code=968,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:1505|[279]\\d{3}|500)\\d{4}|800\\d{5,6}",
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="1505\\d{4}|(?:7(?:[1289]\\d|69|7[0-5])|9(?:0[1-9]|[1-9]\\d))\\d{5}",
    ...
    number_format=[
        ...
        NumberFormat(
            pattern="(\\d{2})(\\d{6})", format="\\1 \\2", leading_digits_pattern=["2"]
        ),
        NumberFormat(
            pattern="(\\d{4})(\\d{4})",
            format="\\1 \\2",
