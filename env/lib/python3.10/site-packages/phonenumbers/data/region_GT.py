...
PHONE_METADATA_GT = PhoneMetadata(
    id="GT",
    country_code=502,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:1\\d{3}|[2-7])\\d{7}", possible_length=(8, 11)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="[267][2-9]\\d{6}",
    ...
    toll_free=PhoneNumberDesc(
        national_number_pattern="18[01]\\d{8}",
        example_number="18001112222",
        possible_length=(11,),
    ),
    premium_rate=PhoneNumberDesc(
        national_number_pattern="19\\d{9}",
        example_number="19001112222",
        possible_length=(11,),
    ),
    number_format=[
        NumberFormat(
