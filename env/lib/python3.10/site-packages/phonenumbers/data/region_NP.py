...
PHONE_METADATA_NP = PhoneMetadata(
    id="NP",
    country_code=977,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:1[0-6]\\d|99[02-6])\\d{5}|(?:2[13-79]|3[135-8]|4[146-9]|5[135-7]|6[13-9]|7[15-9]|8[1-46-9]|9[1-7])[2-6]\\d{5}",
    ...
    number_format=[
        ...
        NumberFormat(
            pattern="(\\d{3})(\\d{7})", format="\\1-\\2", leading_digits_pattern=["9"]
        ),
        NumberFormat(
            pattern="(\\d{4})(\\d{2})(\\d{5})",
            format="\\1-\\2-\\3",
    ...
    intl_number_format=[
        NumberFormat(
            pattern="(\\d)(\\d{7})", format="\\1-\\2", leading_digits_pattern=["1[2-6]"]
        ),
        NumberFormat(
            pattern="(\\d{2})(\\d{6})",
            format="\\1-\\2",
