...
PHONE_METADATA_PE = PhoneMetadata(
    id="PE",
    country_code=51,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:(?:4[34]|5[14])[0-8]\\d|7(?:173|3[0-8]\\d)|8(?:10[05689]|6(?:0[06-9]|1[6-9]|29)|7(?:0[569]|[56]0)))\\d{4}|(?:1[0-8]|4[12]|5[236]|6[1-7]|7[246]|8[2-4])\\d{6}",
