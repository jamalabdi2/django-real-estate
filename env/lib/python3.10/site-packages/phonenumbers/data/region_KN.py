...
PHONE_METADATA_KN = PhoneMetadata(
    id="KN",
    country_code=1,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="869(?:2(?:29|36)|302|4(?:6[015-9]|70)|56[5-7])\\d{4}",
        example_number="8692361234",
        possible_length=(10,),
        possible_length_local_only=(7,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="869(?:48[89]|55[6-8]|66\\d|76[02-7])\\d{4}",
        example_number="8697652917",
        possible_length=(10,),
        possible_length_local_only=(7,),
    ),
