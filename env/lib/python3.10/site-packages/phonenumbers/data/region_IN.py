...
PHONE_METADATA_IN = PhoneMetadata(
    ...
    mobile=PhoneNumberDesc(
        ...
        example_number="8123456789",
        possible_length=(10,),
    ),
    toll_free=PhoneNumberDesc(
        national_number_pattern="000800\\d{7}|1(?:600\\d{6}|80(?:0\\d{4,9}|3\\d{9}))",
        example_number="1800123456",
        possible_length=(8, 9, 10, 11, 12, 13),
    ),
    premium_rate=PhoneNumberDesc(
        national_number_pattern="186[12]\\d{9}",
        example_number="1861123456789",
        possible_length=(13,),
    ),
    shared_cost=PhoneNumberDesc(
        national_number_pattern="1860\\d{7}",
        example_number="18603451234",
        possible_length=(11,),
    ),
    uan=PhoneNumberDesc(
        national_number_pattern="140\\d{7}",
        example_number="1409305260",
        possible_length=(10,),
    ),
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="1(?:600\\d{6}|800\\d{4,9})|(?:000800|18(?:03\\d\\d|6(?:0|[12]\\d\\d)))\\d{7}",
        possible_length=(8, 9, 10, 11, 12, 13),
    ),
    national_prefix="0",
    national_prefix_for_parsing="0",
    number_format=[
        NumberFormat(pattern="(\\d{7})", format="\\1", leading_digits_pattern=["575"]),
        NumberFormat(
            pattern="(\\d{8})",
            format="\\1",
        ...
        NumberFormat(
            ...
            format="\\1 \\2 \\3",
            leading_digits_pattern=["1(?:6|8[06])", "1(?:6|8[06]0)"],
            national_prefix_optional_when_formatting=True,
        ),
        NumberFormat(
