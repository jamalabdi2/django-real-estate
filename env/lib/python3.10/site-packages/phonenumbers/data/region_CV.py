...
PHONE_METADATA_CV = PhoneMetadata(
    id="CV",
    country_code=238,
    international_prefix="0",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:[2-59]\\d\\d|800)\\d{4}", possible_length=(7,)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="2(?:2[1-7]|3[0-8]|4[12]|5[1256]|6\\d|7[1-3]|8[1-5])\\d{4}",
