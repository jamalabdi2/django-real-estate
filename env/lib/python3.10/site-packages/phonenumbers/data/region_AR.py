...
PHONE_METADATA_AR = PhoneMetadata(
    id="AR",
    country_code=54,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:11|[89]\\d\\d)\\d{8}|[2368]\\d{9}",
    ...
    mobile=PhoneNumberDesc(
        ...
        example_number="91123456789",
        possible_length=(10, 11),
        possible_length_local_only=(6, 7, 8),
    ),
    toll_free=PhoneNumberDesc(
        national_number_pattern="800\\d{7,8}",
        example_number="8001234567",
        possible_length=(10, 11),
    ),
    premium_rate=PhoneNumberDesc(
        national_number_pattern="60[04579]\\d{7}",
        example_number="6001234567",
        possible_length=(10,),
    ),
    uan=PhoneNumberDesc(
        national_number_pattern="810\\d{7}",
        example_number="8101234567",
        possible_length=(10,),
    ),
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="810\\d{7}", possible_length=(10,)
    ),
    national_prefix="0",
    ...
    number_format=[
        NumberFormat(
            pattern="(\\d{3})",
            format="\\1",
            leading_digits_pattern=["0|1(?:0[0-35-7]|1[02-5]|2[015]|3[47]|4[478])|911"],
        ),
        NumberFormat(
            pattern="(\\d{2})(\\d{4})",
            format="\\1-\\2",
