...
PHONE_METADATA_KR = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="00[1-9]\\d{8,11}|(?:[12]|5\\d{3})\\d{7}|[13-6]\\d{9}|(?:[1-6]\\d|80)\\d{7}|[3-6]\\d{4,5}|(?:00|7)0\\d{8}",
        possible_length=(5, 6, 8, 9, 10, 11, 12, 13, 14),
        possible_length_local_only=(3, 4, 7),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:2|3[1-3]|[46][1-4]|5[1-5])[1-9]\\d{6,7}|(?:3[1-3]|[46][1-4]|5[1-5])1\\d{2,3}",
        example_number="22123456",
        possible_length=(5, 6, 8, 9, 10),
        possible_length_local_only=(3, 4, 7),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="1(?:05(?:[0-8]\\d|9[0-6])|22[13]\\d)\\d{4,5}|1(?:0[1-46-9]|[16-9]\\d|2[013-9])\\d{6,7}",
        example_number="1020000000",
        possible_length=(9, 10),
    ),
    toll_free=PhoneNumberDesc(
        national_number_pattern="00(?:308\\d{6,7}|798\\d{7,9})|(?:00368|80)\\d{7}",
    ...
    uan=PhoneNumberDesc(
        national_number_pattern="1(?:5(?:22|33|44|66|77|88|99)|6(?:[07]0|44|6[168]|88)|8(?:00|33|55|77|99))\\d{4}",
        example_number="15441234",
        possible_length=(8,),
    ),
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="00(?:3(?:08\\d{6,7}|68\\d{7})|798\\d{7,9})",
    ...
    number_format=[
        NumberFormat(
            pattern="(\\d{5})",
            format="\\1",
            leading_digits_pattern=["1[016-9]1", "1[016-9]11", "1[016-9]114"],
        ...
        NumberFormat(
            pattern="(\\d{4})(\\d{4})", format="\\1-\\2", leading_digits_pattern=["1"]
        ),
        NumberFormat(
            pattern="(\\d)(\\d{3,4})(\\d{4})",
            format="\\1-\\2-\\3",
