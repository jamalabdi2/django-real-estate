...
PHONE_METADATA_FI = PhoneMetadata(
    id="FI",
    country_code=358,
    international_prefix="00|99(?:[01469]|5(?:[14]1|3[23]|5[59]|77|88|9[09]))",
    general_desc=PhoneNumberDesc(
        national_number_pattern="[1-35689]\\d{4}|7\\d{10,11}|(?:[124-7]\\d|3[0-46-9])\\d{8}|[1-9]\\d{5,8}",
        possible_length=(5, 6, 7, 8, 9, 10, 11, 12),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:1[3-79][1-8]|[235689][1-8]\\d)\\d{2,6}",
    ...
    uan=PhoneNumberDesc(
        national_number_pattern="20\\d{4,8}|60[12]\\d{5,6}|7(?:099\\d{4,5}|5[03-9]\\d{3,7})|20[2-59]\\d\\d|(?:606|7(?:0[78]|1|3\\d))\\d{7}|(?:10|29|3[09]|70[1-5]\\d)\\d{4,8}",
        example_number="10112345",
        possible_length=(5, 6, 7, 8, 9, 10, 11, 12),
    ),
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="20(?:2[023]|9[89])\\d{1,6}|(?:60[12]\\d|7099)\\d{4,5}|(?:606|7(?:0[78]|1|3\\d))\\d{7}|(?:[1-3]00|7(?:0[1-5]\\d\\d|5[03-9]))\\d{3,7}",
        possible_length=(5, 6, 7, 8, 9, 10, 11, 12),
    ),
