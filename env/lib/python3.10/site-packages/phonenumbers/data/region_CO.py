...
PHONE_METADATA_CO = PhoneMetadata(
    id="CO",
    country_code=57,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="601055(?:[0-4]\\d|50)\\d\\d|6010(?:[0-4]\\d|5[0-4])\\d{4}|60[124-8][2-9]\\d{6}",
        example_number="6012345678",
        possible_length=(10,),
        possible_length_local_only=(7,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="3333(?:0(?:0\\d|1[0-5])|[4-9]\\d\\d)\\d{3}|(?:3(?:24[1-9]|3(?:00|3[0-24-9]))|9101)\\d{6}|3(?:0[0-5]|1\\d|2[0-3]|5[01]|70)\\d{7}",
    ...
    intl_number_format=[
        NumberFormat(
            pattern="(\\d{3})(\\d{7})", format="\\1 \\2", leading_digits_pattern=["6"]
        ),
        NumberFormat(
            pattern="(\\d{3})(\\d{7})",
            format="\\1 \\2",
