...
PHONE_METADATA_CR = PhoneMetadata(
    id="CR",
    country_code=506,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:8\\d|90)\\d{8}|(?:[24-8]\\d{3}|3005)\\d{4}",
        possible_length=(8, 10),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="210[7-9]\\d{4}|2(?:[024-7]\\d|1[1-9])\\d{5}",
        example_number="22123456",
        possible_length=(8,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:3005\\d|6500[01])\\d{3}|(?:5[07]|6[0-4]|7[0-3]|8[3-9])\\d{6}",
