...
PHONE_METADATA_RS = PhoneMetadata(
    id="RS",
    country_code=381,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="38[02-9]\\d{6,9}|6\\d{7,9}|90\\d{4,8}|38\\d{5,6}|(?:7\\d\\d|800)\\d{3,9}|(?:[12]\\d|3[0-79])\\d{5,10}",
        possible_length=(6, 7, 8, 9, 10, 11, 12),
        possible_length_local_only=(4, 5),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:11[1-9]\\d|(?:2[389]|39)(?:0[2-9]|[2-9]\\d))\\d{3,8}|(?:1[02-9]|2[0-24-7]|3[0-8])[2-9]\\d{4,9}",
