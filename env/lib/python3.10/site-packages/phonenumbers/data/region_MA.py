...
PHONE_METADATA_MA = PhoneMetadata(
    id="MA",
    country_code=212,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="[5-8]\\d{8}", possible_length=(9,)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="5293[01]\\d{4}|5(?:2(?:[0-25-7]\\d|3[1-578]|4[02-46-8]|8[0235-7]|9[0-289])|3(?:[0-47]\\d|5[02-9]|6[02-8]|8[0189]|9[3-9])|(?:4[067]|5[03])\\d)\\d{5}",
        example_number="520123456",
        possible_length=(9,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:6(?:[0-79]\\d|8[0-247-9])|7(?:[017]\\d|2[0-2]|6[0-8]|8[0-3]))\\d{6}",
