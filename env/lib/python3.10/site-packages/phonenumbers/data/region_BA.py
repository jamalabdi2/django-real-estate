...
PHONE_METADATA_BA = PhoneMetadata(
    id="BA",
    country_code=387,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:3(?:[05-79][2-9]|1[4579]|[23][24-9]|4[2-4689]|8[2457-9])|49[2-579]|5(?:0[2-49]|[13][2-9]|[268][2-4679]|4[4689]|5[2-79]|7[2-69]|9[2-4689]))\\d{5}",
    ...
    uan=PhoneNumberDesc(
        national_number_pattern="703[235]0\\d{3}|70(?:2[0-5]|3[0146]|[56]0)\\d{4}",
