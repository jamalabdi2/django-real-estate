...
PHONE_METADATA_RW = PhoneMetadata(
    id="RW",
    country_code=250,
    international_prefix="00",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:06|[27]\\d\\d|[89]00)\\d{6}", possible_length=(8, 9)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:06|2[23568]\\d)\\d{6}",
        example_number="250123456",
        possible_length=(8, 9),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="7[2389]\\d{7}",
        example_number="720123456",
        possible_length=(9,),
    ),
