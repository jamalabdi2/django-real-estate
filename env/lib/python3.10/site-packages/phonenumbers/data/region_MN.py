...
PHONE_METADATA_MN = PhoneMetadata(
    id="MN",
    country_code=976,
    ...
    fixed_line=PhoneNumberDesc(
        national_number_pattern="[12]2[1-3]\\d{5,6}|(?:(?:[12](?:1|27)|5[368])\\d\\d|7(?:0(?:[0-5]\\d|7[078]|80)|128))\\d{4}|[12](?:3[2-8]|4[2-68]|5[1-4689])\\d{6,7}",
        example_number="53123456",
        possible_length=(8, 9, 10),
        possible_length_local_only=(4, 5, 6),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:83[01]|92[039])\\d{5}|(?:5[05]|6[069]|8[015689]|9[013-9])\\d{6}",
        example_number="88123456",
        possible_length=(8,),
    ),
    voip=PhoneNumberDesc(
        national_number_pattern="712[0-79]\\d{4}|7(?:1[013-9]|[25-9]\\d)\\d{5}",
